...
**See `PUBLISHING_BLUEPRINT.md`** for the full operational picture — how a real publish (video, episode, article, interaction) actually flows through the ecosystem end to end. This section is the rule; that doc is the map.
